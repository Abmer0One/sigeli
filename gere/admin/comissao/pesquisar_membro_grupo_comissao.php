...
<?php
  ...
  $sth = $conectar->prepare('SELECT * FROM membro INNER JOIN grupo on membro.id_grupo = grupo.id_grupo where grupo.id_comissao = :id_comissao AND nome_membro LIKE :nome_membro');
...
<div class="container">
    ...
    <div class="col d-flex flex-column align-items-center text-center">
      <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" action="pesquisar_membro_grupo_comissao.php" method="GET">
