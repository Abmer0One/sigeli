        ...
        <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">LISTA DE PROCLAMADORES</h3>
                </div>
                <div class="col text-right">
                  <a href="proclamadores_da_missa.php" class="btn btn-primary">Registar Proclamadores</a>  
                </div>
              </div>
            </div>
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    <th scope="row"><?php echo $d->current()->id_escala_proclamador. "<br />"; ?></th> 
