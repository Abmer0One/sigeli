<?php
      ...
      $id_comissao_grupo = $_SESSION['tipo_nivel'];

      $pdoGrupos = conectarPDO();
      $num_grupos = $pdoGrupos->prepare('SELECT * FROM grupo WHERE id_comissao = :id_comissao_grupo');
      $num_grupos->bindParam(':id_comissao_grupo', $id_comissao_grupo, PDO::PARAM_INT);
      $num_grupos->execute();
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h3 class="card-title text-uppercase text-muted mb-0"><?php  echo $num_grupos->rowCount(); ?></h3>
                      <span class="h2 font-weight-bold mb-0">Grupos</span>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">Membros</span>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">Actividades</span>
                    </div>
                    <div class="col-auto">
