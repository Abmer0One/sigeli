...
<body>
  ...
  <nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scrollbar-inner">
      <!-- Brand -->
      <div class="sidenav-header  align-items-center justify-content-lg-between">
        
          <?php 
        $dados = pegarPeloIDComPDOcomissao($_SESSION['tipo_nivel']); 
        $d = new ArrayIterator($dados);?>
        <?php while($d->valid()){?>
          <h1><?php echo $d->current()->nome_comissao; ?></h1>
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="registar_emprestimo.php">
                <i class="ni ni-planet text-orange"></i>
                <span class="nav-link-text">Emprestimo</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="registar_reserva.php">
