...
<div class="container">
	...
	<div class="row my-2">
      ...
      <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" action="pesquisar_membro.php" method="GET">
				...
				<div class="card-body">
                  ...
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <button class="btn btn-outline-danger"><a href="#" class="card-link card-danger">Alterar</a></button>
                    </div>
                  </div>
                </div>
            </div>
